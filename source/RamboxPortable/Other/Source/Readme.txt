...
user in an INI file next to RamboxPortable.exe called RamboxPortable.ini.
...
copy AppNamePortable.ini from this directory to RamboxPortable.ini next to
RamboxPortable.exe. The options in the INI file are as follows:
